...
export default function App(){
  ...
  const applyUser=useCallback(async(prof,{forceReload=false}={})=>{
    ...
    setCurrentUser(prev=>{
      ...
      const keys=["plan","role","name","email","avatar","subscriptionStatus","currentPeriodStart","currentPeriodEnd","cancelAtPeriodEnd","assignedAgentId","status","businessName","napScore","canImpersonate","pendingPlanId","pendingPlanEffectiveAt","paymentFailedAt","paymentGraceEndsAt","notifyEmail","notifyEmailPending","reportEmail","reportSentMonth"];
