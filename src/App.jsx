...
export default function App(){
  ...
  const applyUser=useCallback(async(prof,{forceReload=false}={})=>{
    ...
    setCurrentUser(prev=>{
      ...
      const keys=["plan","role","name","email","avatar","subscriptionStatus","currentPeriodStart","currentPeriodEnd","cancelAtPeriodEnd","assignedAgentId","assignedBdmId","bdmConnectRequestedAt","status","businessName","phone","address","city","state","zip","category","website","gbpId","napScore","canImpersonate","canViewFinance","pendingPlanId","pendingPlanEffectiveAt","paymentFailedAt","paymentGraceEndsAt","notifyEmail","notifyEmailPending","reportEmail","reportSentMonth"];
