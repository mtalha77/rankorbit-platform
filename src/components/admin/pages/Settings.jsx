...
function buildConfig(settings) {
  return {
    ...
    popularPlan: "growth",
    ...(settings?.config || {}),
    // Retired $1 test plan — never sell again even if old settings still have it live.
    livePlanTestPlan: false,
    ...((settings?.config?.popularPlan === "test-plan") ? { popularPlan: "growth" } : {}),
  };
}
