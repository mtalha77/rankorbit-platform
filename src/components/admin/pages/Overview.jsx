...
export function Overview() {
  const { isMobile, user, isAdmin, notifBadge, setPage, setSelClient, revenue, clients, listings, totalLive, totalPending, totalFlagged, actionNeeded, flat, activity } = useAdmin();
